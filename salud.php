    ...
    <section class="cabeceraBienvenida" id="home">
            ...
            <div class="metrica" style="">
                ...
                <div class="tituloCabecera">
                    ...
                    <h2 ><span style="color:#fff">|</span><img src="http://www.idec.org.br/sites/default/files/icones/ico-saude-05.svg" alt="Programa Temático" title="Ver programa temático"> Salud</h2>
...
<br>
    ...
    <section class="dondeReclamar clearfix">
        <div class="container" style="display: inline-flex;padding: 0% 10%">
            <h1 style="color:#fff">¿Dónde Reclamar?</h1> <img src="img/bg-img/susalud.png" width="447px" height="175px" style="padding: 0 0 0 25px">

        </div>
    </section>
    <!-- ***** Donde reclamar Area End ***** -->
