    ...
    <section class="cabeceraBienvenida" id="home">
            ...
            <div class="metrica" style="">
                ...
                <div class="tituloCabecera">
                    ...
                    <h2 ><span style="color:#fff">|</span> Energía</h2>
                ...
                <div class="col-12 col-md-3 col-lg-3">
                    <div class="single-cool-fact d-flex justify-content-center wow fadeInUp" data-wow-delay="0.2s">
                        <div class="counter-area">
                            <h3><span class="counter">290</span></h3>
                        </div>
                            ...
                            <div id="sitio" style="display:block;padding: 4%">
                                    ...
                                    <table >
                                        <TR >
                                            ...
                                            <TD style="border:1px solid #ab43da">ENERGÍA</TD> 
                                        </TR>
                                        <TR>
                                            <TH style="border:1px solid #ab43da">Provincia</TH>
                                            <TD style="border:1px solid #ab43da">LIMA</TD> 
                                        </TR>
                                        <TR><TH style="border:1px solid #ab43da">% Reclamos en el Departamento</TH>
                                ...
                                <style>
                                    ...
                                    <table >
                                        <TR >
                                            ...
                                            <TD style="border:1px solid #ab43da">130</TD> 
                                        </TR>
                                        <TR>
                                            <TH style="border:1px solid #ab43da">Conciliados</TH>
                                            <TD style="border:1px solid #ab43da">60</TD> 
                                        </TR>
                                        <TR><TH style="border:1px solid #ab43da">No Conciliados</TH>
                                            <TD style="border:1px solid #ab43da">40</TD> 
                                        </TR>
                                        <TR><TH style="border:1px solid #ab43da">Reportes Abandono</TH>
                                            <TD style="border:1px solid #ab43da">5</TD> 
                                        </TR>
                                    </table>
                                    <br>
...
<div class="popup" style="z-index: 9999999">
  ...
  <a class="button" ><img src="img/bg-img/reclamo.svg" width="40" /></a>
    ...
    <section class="dondeReclamar clearfix" style="width:100%;"">
        <div class="container" style="width:80%;display: inline-flex;margin:0 25%;">
            <h1 style="color:#fff;vertical-align: middle;">¿Dónde Reclamar?</h1>
             ...
             <img src="img/bg-img/opsitel.png" width="385" height="115" style="padding: 0 0 0 25px">
    ...
    <section class="footer-contact-area section_padding_100 clearfix" id="reporta">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <!-- Heading Text  -->
